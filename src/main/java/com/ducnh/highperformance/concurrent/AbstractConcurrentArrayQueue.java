...
public abstract class AbstractConcurrentArrayQueue<E>
	...
	static {
		try {
			...
			TAIL_OFFSET = UnsafeApi.objectFieldOffset(AbstractConcurrentArrayQueueProducer.class.getDeclaredField("tail"));
			...
			HEAD_OFFSET = UnsafeApi.objectFieldOffset(AbstractConcurrentArrayQueueConsumer.class.getDeclaredField("head"));
